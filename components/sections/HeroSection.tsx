...
import { Mail, MapPin, Download, ArrowRight, Briefcase, FolderGit2, Cpu, MonitorSmartphone } from "lucide-react";
...
const technologies = [
  ...
  "NestJS", "PostgreSQL", "MongoDB", "Prisma", "TypeScript", "PHP", "Laravel"
];
...
const socialLinks = [
  ...
  { icon: Mail, href: "mailto:arfajsheru@gmail.com", label: "Email" },
  { icon: WhatsappIcon, href: "https://wa.me/919913690041", label: "WhatsApp" },
];
...
export function HeroSection() {
  return (
    <section
      id="home"
      className="relative min-h-screen pt-24 pb-16 md:pt-32 flex items-center overflow-hidden hero-bg"
    >
          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="flex flex-col sm:flex-row items-start sm:items-center gap-6 pt-2">
              <div className="flex flex-row gap-3 w-full sm:w-auto">
                <Button asChild size="lg" className="w-1/2 sm:w-auto h-10 px-4 sm:h-12 sm:px-6 text-xs sm:text-sm rounded-full bg-foreground text-background hover:bg-foreground/90 transition-all shadow-lg hover:shadow-xl group">
                  <Link href="#projects">
                    View Projects <ArrowRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 ml-1.5 sm:ml-2 transition-transform duration-300 group-hover:translate-x-1" />
                  </Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="w-1/2 sm:w-auto h-10 px-4 sm:h-12 sm:px-6 text-xs sm:text-sm rounded-full border-border/50 bg-background/50 backdrop-blur-md hover:bg-muted/50 transition-all shadow-sm hover:shadow-md">
                  <a href="/Arfaj_Sheru_CV.pdf" target="_blank" rel="noopener noreferrer" download>
                    <Download className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" /> Download Resume
                  </a>
                </Button>
              </div>
            ...
            <motion.div variants={fadeUpVariants} className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-5">
              {[
                ...
                <div
                  key={i}
                  className="relative group flex flex-col items-start p-5 bg-background/80 dark:bg-zinc-900/80 border border-border/60 backdrop-blur-md text-left space-y-3 h-full min-h-[110px] hover:-translate-y-1 hover:shadow-lg transition-all duration-300"
                  style={{
                ...
                >
                  ...
                  <div className="absolute top-0 left-0 w-4 h-[2px] bg-border group-hover:bg-foreground/50 transition-colors" />
                  <div className="absolute top-0 left-0 w-[2px] h-4 bg-border group-hover:bg-foreground/50 transition-colors" />
                  <div className="absolute bottom-0 right-0 w-4 h-[2px] bg-border group-hover:bg-foreground/50 transition-colors" />
                  <div className="absolute bottom-0 right-0 w-[2px] h-4 bg-border group-hover:bg-foreground/50 transition-colors" />
              ...
              <div className="p-6 overflow-x-auto text-[#abb2bf] text-[13px] sm:text-sm leading-relaxed">
                <div className="flex">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="pl-6">
                      <span className="text-[#e06c75]">skills</span>: <span className="text-[#abb2bf]">[</span><span className="text-[#98c379]">"React"</span>, <span className="text-[#98c379]">"Next.js"</span>, <span className="text-[#98c379]">"Node.js"</span>, <span className="text-[#98c379]">"React</span>
                    </span>
                    <span className="pl-6">
                      <span className="text-[#98c379]">Native"</span><span className="text-[#abb2bf]">]</span>,
                    </span>
                    <span className="pl-6">
